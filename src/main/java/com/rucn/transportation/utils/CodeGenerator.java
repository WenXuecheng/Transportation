        ...
        FastAutoGenerator.create("jdbc:mysql://free1.mysql.database.azure.com/rucn?characterEncoding=utf8&useSSL=true&requireSSL=true", "root_azure", "Qq5515150")
                .globalConfig(builder -> {
                    builder.author("Wen") // 设置作者
                            ...
                            .outputDir("D:\\pro\\Transportation\\src\\main\\java\\"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.rucn.transportation") // 设置父包名
                            .moduleName(null) // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "D:\\pro\\Transportation\\src\\main\\resources\\mapper")); // 设置mapperXml生成路径
                })
